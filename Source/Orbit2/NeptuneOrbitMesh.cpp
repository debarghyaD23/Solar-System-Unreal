...
#include "NeptuneOrbitMesh.h"

// Sets default values
//const int32 NumSegments = 360;
ANeptuneOrbitMesh::ANeptuneOrbitMesh()
{
...
void ANeptuneOrbitMesh::BeginPlay()
{
	Super::BeginPlay();
...
void ANeptuneOrbitMesh::GenerateHollowEllipseMesh()
{
	...
	const float OuterRadiusX = 13300.0f;
	const float OuterRadiusY = 13250.0f;
...
// Called every frame
//void ANeptuneOrbitMesh::Tick(float DeltaTime)
//{

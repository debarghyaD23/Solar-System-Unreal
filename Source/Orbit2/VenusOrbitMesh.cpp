...
#include "VenusOrbitMesh.h"

// Sets default values
//const int32 NumSegments = 360;
AVenusOrbitMesh::AVenusOrbitMesh()
{
...
void AVenusOrbitMesh::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
//void AVenusOrbitMesh::Tick(float DeltaTime)
//{
//	Super::Tick(DeltaTime);
//
//}

void AVenusOrbitMesh::GenerateHollowEllipseMesh() {

...
#include "MarsOrbitMesh.h"

// Sets default values
//const int32 NumSegments = 360;
AMarsOrbitMesh::AMarsOrbitMesh()
{
...
// Called every frame
//void AMarsOrbitMesh::Tick(float DeltaTime)
//{
//	Super::Tick(DeltaTime);
//
//}

void AMarsOrbitMesh::GenerateHollowEllipseMesh() {
	...
	const float OuterRadiusX = 7300.0f;
	const float OuterRadiusY = 7250.0f;

...
#include "JupiterOrbitMesh.h"

// Sets default values
const int32 NumSegments = 360;
AJupiterOrbitMesh::AJupiterOrbitMesh()
{
...
void AJupiterOrbitMesh::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
//void AJupiterOrbitMesh::Tick(float DeltaTime)
//{
//	Super::Tick(DeltaTime);
//
//}

void AJupiterOrbitMesh::GenerateHollowEllipseMesh() {
	...
	const float OuterRadiusX = 8300.0f;
	const float OuterRadiusY = 8250.0f;

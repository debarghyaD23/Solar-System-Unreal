...
AOrbitMesh::AOrbitMesh()
{
	ProceduralMeshComponent = CreateDefaultSubobject<UProceduralMeshComponent>(TEXT("ProceduralMeshComponent"));
	RootComponent = ProceduralMeshComponent;

}
void AOrbitMesh::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AOrbitMesh::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void AOrbitMesh::GenerateHollowEllipseMesh()
{
	...
	const float OuterRadiusX = 6300.0f;
	const float OuterRadiusY = 6100.0f;
